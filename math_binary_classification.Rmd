...
# savemodel(DT_amb, paste(model_dir, "/dt_amb", sep = ""))

# Save models and manually move all models into ../Models
savemodel(DT_amb, "dt_amb.model")
savemodel(DT_amb, "dt_bmb.model")
savemodel(DT_amb, "dt_cmb.model")
savemodel(RF_amb, "rf_amb.model")
savemodel(RF_bmb, "rf_bmb.model")
savemodel(RF_cmb, "rf_cmb.model")
